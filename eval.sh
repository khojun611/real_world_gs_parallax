...
# python -u eval.py --model_path ./output/ball_blackback/ball_blackback-0702_0804 --save_images
#python -u eval.py --model_path ./output/chrome_book/chrome_book-0702_1105 --save_images
#python -u eval.py --model_path ./output/chrome_paper/chrome_paper-0702_1105 --save_images
#python -u eval.py --model_path ./output/tv/tv-0708_1112 --save_images
#python -u eval.py --model_path ./output/fig/fig-0708_1227 --save_images
#python -u eval.py --model_path ./output/pot1/pot1-0708_1332 --save_images
# python -u eval.py --model_path ./output/pot2/pot2-0708_1442 --save_images

#python -u eval.py --model_path ./output/postcase1/postcase1-0710_0813 --save_images
#python -u eval.py --model_path ./output/tv/tv-0710_0926 --save_images
#python -u eval.py --model_path ./output/car/car-0710_0645 --save_images

#python -u eval.py --model_path ./output_0708/chrome5/chrome5-0701_1516 --save_images

#python -u eval.py --model_path  ./output/toaster/toaster-0711_0311 --save_images
#python -u eval.py --model_path  ./output/car/car-0711_0403 --save_images
